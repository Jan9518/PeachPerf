package com.peach.perf.permissions
...
import com.peach.perf.御史中丞
import com.peach.perf.common.shell.KeepShellPublic
import com.peach.perf.common.ui.DialogHelper
import com.peach.perf.utils.CommonCmds
import com.peach.perf.R
                ...
                if (it == Manifest.permission.MANAGE_EXTERNAL_STORAGE) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (!Settings.canDrawOverlays(context)) {
                            ...
                            try {
                                //启动Activity让用户授权
                                // Toast.makeText(context, "御史中丞未获得显示悬浮窗权限", Toast.LENGTH_SHORT).show()
